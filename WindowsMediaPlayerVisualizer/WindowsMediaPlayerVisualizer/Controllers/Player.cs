...
namespace WindowsMediaPlayerVisualizer.Controllers
{
    public class Player
    {
        ...
        private Visualizer10 visualizer11;
            ...
            Timer timer1, Label lblCounter, Label lblCountdown, Panel canvas) 
        {
            ...
            visualizer11 = new Visualizer10(canvas);
        ...
        public void tickAction() {
            ...
            else if (currentVisualizer is Visualizer10 v10)
                v10.Update(fftSampleProvider.GetFrequencies(), currentVolume);
        ...
        private void DetachCurrentVisualizer()
        {
            ...
            else if (currentVisualizer is Visualizer10 v10) canvas.Paint -= v10.Canvas_Paint;
